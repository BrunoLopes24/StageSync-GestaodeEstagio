...
export async function weekly(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const summary = await reportService.getWeeklySummary(date, req.userId!);
    res.json(summary);
  } catch (err) {
    next(err);
  }
...
export async function monthly(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const summary = await reportService.getMonthlySummary(month, req.userId!);
    res.json(summary);
  } catch (err) {
    next(err);
  }
...
export async function midtermPdf(req: Request, res: Response, next: NextFunction) {
  try {
    const pdf = await reportService.generateMidtermReportPdf(req.userId!);
